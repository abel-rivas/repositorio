		...
		<?php if ( $meta_news_settings['meta_news_footer_featured_posts_hide'] === 0 ) {
			...
			$footer_meta_news_get_featured_post = new WP_Query($footer_post_type); ?>
				...
				<div class="featured-stories">
					<div class="container">
					<?php meta_news_sections_title($meta_news_settings['meta_news_footer_featured_latest_post'], $meta_news_settings['meta_news_footer_featured_posts_title'], $footer_meta_news_cat); ?>
					<div class="row">
					...
					<div class="site-info-main col-lg">
						<div class="copyright">
							<div class="theme-link">
								<?php echo esc_html__(' Copyright &copy; ','meta-news') . meta_news_the_year() . meta_news_site_link() . esc_html_e('All rights reserved.','meta-news')  ?></div><?php if ( function_exists('the_privacy_policy_link') ) {
								the_privacy_policy_link('<div class="privacy-link">', '</div>');
							}?>
						</div><!-- .copyright -->
						<div class="theme-link">
							<?php echo meta_news_author_link();
							?> 
						</div><!-- author-->
					</div><!-- .site-info-main -->
					<?php
